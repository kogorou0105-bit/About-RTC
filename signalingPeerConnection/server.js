...
expressServer.listen(8080, "0.0.0.0", () => {
  console.log("HTTPS Server is running on https://0.0.0.0:8080");
  console.log(
    "You can also access via your local IP, e.g.: https://10.20.209.47:8080"
  );
});
